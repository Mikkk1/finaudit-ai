      ...
      <table className="min-w-full divide-y divide-light-border">
        <thead className="bg-primary-bg">
          <tr>
            ...
            <th className="px-6 py-4 text-left text-xs font-medium text-slate-gray uppercase tracking-wider">Upload Date</th>
            ...
            >
              ...
              <td className="px-6 py-4 whitespace-nowrap">
                <div className="flex items-center">
                  ...
                  <span className="ml-3 font-medium text-dark-text">{doc.name}</span>
                </div>
              </td>
              <td className="px-6 py-4 whitespace-nowrap text-slate-gray">
                {doc.type}
              </td>
              <td className="px-6 py-4 whitespace-nowrap text-slate-gray">
                {doc.size}
