...
const FileTypeIcon = ({ fileType }: { fileType: string }) => {
  ...
  return (
    <div className="w-16 h-16 flex items-center justify-center bg-primary-bg/10 rounded-2xl 
      ...
      <AnimatePresence>
        {documents.map(doc => (
          ...
          >
            ...
            <div className="p-6 pb-4">
              <div className="flex flex-col items-center">
                ...
                <p className="text-sm text-slate-gray mb-1 flex items-center">
                  <span className="mr-2 capitalize">{doc.file_type.split('/')[1]}</span>
            ...
            {/* Hover Overlay */}
            <div className="absolute inset-0 rounded-2xl bg-navy-blue/5 opacity-0 
